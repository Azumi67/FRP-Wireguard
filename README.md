...
- برای کانفیگ سرور خارج IPV6 ، اگر تانل شما با قرار دادن ایپی 6 خارج کار نکرد، به جای قرار دادن ایپی 6 خارج از 127.0.0.1 استفاده نمایید ( از ایپی 6 خارج هم میتوانید استفاده کنید) و برای ایپی ایران از ایپی 6 ایران استفاده نمایید.
